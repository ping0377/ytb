        ...
        <div class="my-dialog__header">
          <slot name="title">
            ...
            <div @click="handleClose" class="my-dialog__headerbtn">
              <!-- <img src="static/img/u2306.svg" alt /> -->
              <img class="img_" src="static/img/u93.svg" alt="">
            </div>
          </slot>
        </div>
...
.my-dialog__headerbtn {
  ...
  top: -1px;
  right: 10px;
  background: url("../../../static/img/u2306.svg")no-repeat;
  background-size: 100%;
}
 .my-dialog__headerbtn:hover {
  ...
  top: -1px;
  right: 10px;
  background: url("../../../static/img/u2306_mouseOver.svg")no-repeat;
  background-size: 100%;
} 
.title-icon {
  font-size: 14px;
