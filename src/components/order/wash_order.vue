    ...
    <div v-show="wj_page">
      ...
      <div class="tabs_div">
        <el-tabs v-model="activeName" @tab-click="handleClick">
              ...
              <table class="table">
                <tbody>
                  <tr>
                    ...
                    <td width="10%">共1件</td>
                    <td width="10%">￥19.9</td>
                    <td width="10%">张家辉13856996969</td>
                    <td width="20%">杭州市拱墅区萍水街多少多少号</td>
                    <td width="10%">待付款</td>
                    <td width="10%">
          ...
          <el-tab-pane label="待接收" name="third">角色管理</el-tab-pane>
          <el-tab-pane label="待清点" name="fourth">定时任务补偿</el-tab-pane>
          <el-tab-pane label="有退款补款" name="five">定时任务补偿</el-tab-pane>
          <el-tab-pane label="待配送" name="six">定时任务补偿</el-tab-pane>
          <el-tab-pane label="洗涤中" name="seven">定时任务补偿</el-tab-pane>
          <el-tab-pane label="未评价" name="eghit">定时任务补偿</el-tab-pane>
          <el-tab-pane label="已完成" name="nine">定时任务补偿</el-tab-pane>
          <el-tab-pane label="已关闭" name="ten">定时任务补偿</el-tab-pane>
        </el-tabs>
      </div>
    </div>
